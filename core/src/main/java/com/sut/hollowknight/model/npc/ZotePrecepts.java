...
/**
 * The Fifty-Seven Precepts of Zote (spec: Dynamic Dialogue States).
 * After the first meeting, each interaction recites the next precept,
 * wrapping back to Precept One after Precept Fifty-Seven.
 *
 * <p>Text sourced from the official dialogue
 * (hollowknight.fandom.com/wiki/Zote).</p>
 */
public final class ZotePrecepts {

    private ZotePrecepts() { }
    ...
    public static String get(int index) {
        return PRECEPTS[((index % COUNT) + COUNT) % COUNT];
    }
}
